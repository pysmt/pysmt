...
class TestArray(TestCase):
    ...
    def test_nested_array_type(self):
        ...
        # Equality tests
        nested2 = ArrayType(ArrayType(INT, INT), ArrayType(INT, INT))
        self.assertEqual(nested, nested2)

        fake_nested = ArrayType(ArrayType(INT, INT), ArrayType(INT, REAL))
    ...
    def test_bv_array(self):
        ...
        formula = Equals(Select(Store(a, BV(10, 8), BV(100, 8)), BV(10, 8)), BV(100, 8))
    ...
    def test_complex_types(self):
        with self.assertRaises(PysmtTypeError):
            ...
            Not(
                Equals(
                    Store(Array(REAL, BV(0, 8)), Real(1), BV(5, 8)),
    ...
    def test_infix(self):
        a = Symbol("a", ARRAY_INT_INT)
        self.assertEqual(a.Select(Int(5)), Select(a, Int(5)))
        self.assertEqual(a.Store(Int(5), Int(6)), Store(a, Int(5), Int(6)))
