...
SERIALIZED_EXAMPLES = [
    ...
    """("mystr" = str1)""",
    """((5 < (str.len str1)) & ("mystr" = str1))""",
    """((5 = (str.len str1)) & (( str.++ "my" "str" ) = str1))""",
    """(( str.at "mystr" 1) = "y")""",
    """(str.contains "mystr" "my")""",
    """(( str.indexof "mystr" "str" 1) = 1)""",
    """(( str.replace "mystr" "str" "my") = "mymy")""",
    """(( str.substr "mystr" 2 4) = "str")""",
    """( str.prefixof "my" "mystr")""",
