...
class Theory(object):
    ...
    def __eq__(self, other):
        ...
        return (
            ...
            and self.arrays_const == other.arrays_const
            and self.bit_vectors == other.bit_vectors
            and self.floating_point == other.floating_point
            and self.integer_arithmetic == other.integer_arithmetic
            and self.real_arithmetic == other.real_arithmetic
            and self.integer_difference == other.integer_difference
            and self.real_difference == other.real_difference
            and self.linear == other.linear
            and self.uninterpreted == other.uninterpreted
            and self.custom_type == other.custom_type
    ...
    def __le__(self, other):
        ...
        return (
            ...
            and self.uninterpreted <= other.uninterpreted
            and self.custom_type <= other.custom_type
            and le_integer_difference
            and self.integer_arithmetic <= other.integer_arithmetic
            and le_real_difference
            and self.real_arithmetic <= other.real_arithmetic
            and le_linear
            and self.strings <= other.strings
        )
...
class Logic(object):
    ...
    def __init__(
        self, name, description, quantifier_free=False, theory=None, **theory_kwargs
    ):
        self.name = name
    ...
    def get_quantified_version(self):
        ...
        if self.quantifier_free:
            return self
        target_logic = Logic(
            name="", description="", quantifier_free=False, theory=self.theory
        )
    ...
    def __eq__(self, other):
        ...
        return (
            ...
            and self.quantifier_free == other.quantifier_free
...
QF_BOOL = Logic(
    name="QF_BOOL",
    description="""The simplest logic: quantifier-free boolean logic.""",
    quantifier_free=True,
)

BOOL = Logic(name="BOOL", description="""Quantified boolean logic.""")
QBF = BOOL  # Provide additional name for consistency with literature


QF_BOOLt = Logic(
    name="QF_BOOLt",
    description="""Quantifier-free boolean logic with custom sorts.""",
    quantifier_free=True,
    custom_type=True,
)
...
AUFLIA = Logic(
    name="AUFLIA",
    description="""Closed formulas over the theory of linear integer arithmetic and
...
AUFLIRA = Logic(
    name="AUFLIRA",
    description="""Closed linear formulas with free sort and function symbols over
...
AUFNIRA = Logic(
    name="AUFNIRA",
    description="""Closed formulas with free function and predicate symbols over a
...
UFLIRA = Logic(
    name="UFLIRA",
    description="""Closed linear formulas with free sort and function symbols in
...
QF_UFLIRA = Logic(
    name="QF_UFLIRA",
    description="""Quantifier-free, closed linear formulas with free sort and function symbols in
linear and real arithmetic.""",
    integer_arithmetic=True,
    real_arithmetic=True,
    linear=True,
...
QF_ABV = Logic(
    name="QF_ABV",
    description="""Closed quantifier-free formulas over the theory of bitvectors and
bitvector arrays.""",
    quantifier_free=True,
    arrays=True,
    bit_vectors=True,
...
QF_AUFLIA = Logic(
    name="QF_AUFLIA",
    description="""Closed quantifier-free linear formulas over the theory of integer
...
QF_AX = Logic(
    name="QF_AX",
    description="""Closed quantifier-free formulas over the theory of arrays with
extensionality.""",
    quantifier_free=True,
    arrays=True,
)
...
QF_BV = Logic(
    name="QF_BV",
    description="""Closed quantifier-free formulas over the theory of fixed-size
bitvectors.""",
    quantifier_free=True,
    bit_vectors=True,
)
...
BV = Logic(
    name="BV",
    description="""Closed formulas over the theory of fixed-size
bitvectors.""",
    bit_vectors=True,
)
...
UFBV = Logic(
    name="UFBV",
    description="""Closed formulas over the theory of fixed-size bitvectors
...
QF_IDL = Logic(
    name="QF_IDL",
    description="""Difference Logic over the integers. In essence, Boolean
...
QF_LIA = Logic(
    name="QF_LIA",
    description="""Unquantified linear integer arithmetic. In essence, Boolean
...
QF_LRA = Logic(
    name="QF_LRA",
    description="""Unquantified linear real arithmetic. In essence, Boolean
...
QF_RDL = Logic(
    name="QF_RDL",
    description="""Difference Logic over the reals. In essence, Boolean combinations
...
QF_UF = Logic(
    name="QF_UF",
    description="""Unquantified formulas built over a signature of uninterpreted
...
UF = Logic(
    name="UF",
    description="""Quantified formulas built over a signature of uninterpreted
(i.e., free) sort and function symbols.""",
    uninterpreted=True,
)
...
QF_UFBV = Logic(
    name="QF_UFBV",
    description="""Unquantified formulas over bitvectors with uninterpreted sort
...
QF_UFIDL = Logic(
    name="QF_UFIDL",
    description="""Difference Logic over the integers (in essence) but with
...
QF_UFLIA = Logic(
    name="QF_UFLIA",
    description="""Unquantified linear integer arithmetic with uninterpreted sort and
function symbols.""",
    quantifier_free=True,
    integer_arithmetic=True,
    uninterpreted=True,
...
QF_UFLRA = Logic(
    name="QF_UFLRA",
    description="""Unquantified linear real arithmetic with uninterpreted sort and
function symbols.""",
    quantifier_free=True,
    real_arithmetic=True,
    uninterpreted=True,
...
QF_UFNRA = Logic(
    name="QF_UFNRA",
    description="""Unquantified non-linear real arithmetic with uninterpreted sort and
function symbols.""",
    quantifier_free=True,
    real_arithmetic=True,
    linear=False,
...
QF_UFNIA = Logic(
    name="QF_UFNIA",
    description="""Unquantified non-linear integer arithmetic with uninterpreted sort and
function symbols.""",
    quantifier_free=True,
    integer_arithmetic=True,
    linear=False,
...
UFLRA = Logic(
    name="UFLRA",
    description="""Linear real arithmetic with uninterpreted sort and function
symbols.""",
    real_arithmetic=True,
    uninterpreted=True,
)
...
UFNIA = Logic(
    name="UFNIA",
    description="""Non-linear integer arithmetic with uninterpreted sort and function
symbols.""",
    integer_difference=True,
    linear=False,
    uninterpreted=True,
...
QF_SLIA = Logic(
    name="QF_SLIA",
    description="""Extension of LIA including theory of Strings.""",
    integer_arithmetic=True,
    quantifier_free=True,
    uninterpreted=True,
    strings=True,
...
QF_AUFBVLIRA = Logic(
    name="QF_AUFBVLIRA",
    description="""Quantifier free Arrays, Bitvectors and LIRA""",
    linear=True,
    uninterpreted=True,
    quantifier_free=True,
    arrays=True,
...
ARRAYS_CONST_LOGICS = frozenset(_l for _l in PYSMT_LOGICS if _l.theory.arrays_const)
...
def get_logic(
    ...
    for logic in LOGICS:
        if (
            logic.quantifier_free == quantifier_free
            and logic.theory.arrays == arrays
            and logic.theory.arrays_const == arrays_const
            and logic.theory.bit_vectors == bit_vectors
            and logic.theory.floating_point == floating_point
            and logic.theory.integer_arithmetic == integer_arithmetic
            and logic.theory.real_arithmetic == real_arithmetic
            and logic.theory.integer_difference == integer_difference
            and logic.theory.real_difference == real_difference
            and logic.theory.linear == linear
            and logic.theory.uninterpreted == uninterpreted
            and logic.theory.custom_type == custom_type
            and logic.theory.strings == strings
        ):
            return logic
...
def most_generic_logic(logics):
    ...
    if len(res) != 1:
        raise NoLogicAvailableError(
            "Could not find the most generic " "logic for %s." % str(logics)
        )
    return res[0]
